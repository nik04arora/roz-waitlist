...
import { injectClarity } from './clarity-tracking.mjs';
...
for (const page of legacyPages) {
  ...
  await writeFile(resolve(dist, page), injectClarity(injectMetaTracking(injectGoogleAnalytics(page === 'index.html' ? optimizeHomepageHtml(html, homepageStylesheet) : html))));
}
