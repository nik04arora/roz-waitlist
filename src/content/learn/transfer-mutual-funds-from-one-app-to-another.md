---
title: "Can You Transfer Mutual Funds From One App to Another?"
description: "Learn how to move mutual funds between apps in India, why SOA and demat holdings need different steps, and when selling may create tax or exit load."
summary: "Yes, but you may not need to transfer the units at all. If they are held in Statement of Account form, another supported platform may be able to display the same folios. Demat holdings follow a depository transfer process. Selling and buying again is a separate route with possible tax and exit-load consequences."
...
hero:
  type: quote
  quote: "The app is only the window. Your holding record decides how the investment can move."
  attribution: Roz Invest
socialImage: /assets/images/learn/transfer-mutual-funds-from-one-app-to-another-quote-social.png
socialImageAlt: "Quote explaining that a mutual fund app is a window while the holding record determines how investments can move"
articleImages:
  - /assets/images/learn/transfer-mutual-funds-from-one-app-to-another-quote-16x9.jpg
  - /assets/images/learn/transfer-mutual-funds-from-one-app-to-another-quote-4x3.jpg
  - /assets/images/learn/transfer-mutual-funds-from-one-app-to-another-quote-1x1.jpg
sources:
  - title: Consolidated Account Statement
    url: https://www.amfiindia.com/investor/become-mf-distributor?zoneName=consolidatedAcct
    publisher: Association of Mutual Funds in India
  - title: Investor Service FAQs
    url: https://www.amfiindia.com/investor/become-mf-distributor?zoneName=InvestorService
    publisher: Association of Mutual Funds in India
  - title: Consolidated Account Statement
    url: https://investor.sebi.gov.in/consolidated_account_statement.html
    publisher: SEBI Investor
  - title: Understanding Registrar and Transfer Agents
    url: https://investor.sebi.gov.in/registrar_and_transfer_agents.html
    publisher: SEBI Investor
  - title: Frequently Asked Questions by Investors Holding Mutual Fund Units in a Demat Account
    url: https://nsdl.co.in/downloadables/pdf/FAQs-by-Investors-Holding-of-Mutual-Fund-Units.pdf
    publisher: National Securities Depository Limited
  - title: CDSL EASIEST
    url: https://www.cdslindia.com/Footer/Easiest.html
    publisher: Central Depository Services (India) Limited
  - title: Mutual Fund Investments at Groww Can Also Be Held in Your Demat Account
    url: https://groww.in/updates/mutual-fund-investments-at-groww-can-also-be-held-in-your-demat-account
    publisher: Groww
  - title: How to Transfer Mutual Funds From Another Platform to Coin
    url: https://support.zerodha.com/category/mutual-funds/coin-general/transferring-mf/articles/how-do-i-move-my-existing-mutual-fund-investments-to-coin
    publisher: Zerodha
cta:
...
faqs:
  - question: Can I transfer mutual funds from one app to another without selling?
    answer: Often, yes. SOA holdings may only need to be imported or accessed through another supported platform. Demat holdings may be transferred between demat accounts. The exact route depends on the holding mode and the receiving platform's rules.
  - question: How do I know whether my mutual funds are held in SOA or demat form?
    answer: Check the account statement, CAS, app settings or transaction confirmation. SOA holdings normally show an AMC folio, while demat holdings appear in the depository account linked to your DP ID and client ID. Confirm with the AMC, RTA or depository participant if the record is unclear.
  - question: Do I need to redeem mutual funds before changing apps?
    answer: Not necessarily. Importing an SOA folio or transferring eligible demat units can avoid a redemption. Redeeming and reinvesting may be required or chosen in some situations, but it is a sale and fresh purchase rather than a simple app change.
  - question: Does changing a mutual fund app create tax?
    answer: Merely viewing the same SOA folio through another app does not sell the units. A redemption or scheme or plan switch can create a capital-gains event, and other transfer situations may need individual tax review. Check the transaction being submitted rather than the app label.
  - question: Will my existing SIP continue after I change apps?
    answer: Do not assume that the SIP instruction will move automatically. The existing units and the instruction for future instalments are separate. Check the old registration, cancel it if required, and confirm any new SIP mandate before expecting future debits.
  - question: Can locked ELSS units be transferred to another app?
    answer: Changing where an SOA folio is displayed is not a sale or ordinary unit transfer. For demat ELSS units under lock-in, normal transfer routes can be restricted, although a closure-cum-transfer process to another account of the same holder may be available. Confirm the current process with both depository participants.
  - question: Can I move regular mutual funds to a direct plan by changing apps?
    answer: No. The platform, holding mode and plan are separate choices. Moving or displaying the same units elsewhere does not convert regular-plan units into direct-plan units. A plan switch or redemption and fresh purchase may have tax, load or lock-in consequences.
relatedArticles:
...
An app name does not always reveal the holding mode. A platform may support SOA, demat or both, and its default can change. Groww's [April 2025 holding-mode update](https://groww.in/updates/mutual-fund-investments-at-groww-can-also-be-held-in-your-demat-account), accessed 11 September 2026, is one example: it describes both demat holdings and an option to use AMC folios. Check your own record instead of assuming every user of the same app has the same setup.
...
AMFI's [CAS guidance](https://www.amfiindia.com/investor/become-mf-distributor?zoneName=consolidatedAcct), accessed 11 September 2026, says investors can obtain a consolidated statement through CAMS and KFintech and can view mutual fund portfolios and CAS information through MFCentral. It also says the respective mutual fund or registrar should be contacted when a folio is missing or a record is incorrect.

SEBI Investor explains in its [RTA guide](https://investor.sebi.gov.in/registrar_and_transfer_agents.html), accessed 11 September 2026, that registrars and transfer agents maintain mutual fund investor records and process transactions. This is why an SOA holding does not disappear when one consumer app is removed from a phone or stops displaying it.
...
NSDL's [FAQ for investors holding mutual fund units in demat accounts](https://nsdl.co.in/downloadables/pdf/FAQs-by-Investors-Holding-of-Mutual-Fund-Units.pdf), accessed 11 September 2026, says mutual fund units can be transferred between NSDL demat accounts or between different depositories, except for units under lock-in. CDSL's [EASIEST guidance](https://www.cdslindia.com/Footer/Easiest.html), last updated 27 September 2024 and accessed 11 September 2026, describes online off-market and inter-depository transfer instructions, subject to the facility and DP setup.
...
Zerodha's [current transfer instructions](https://support.zerodha.com/category/mutual-funds/coin-general/transferring-mf/articles/how-do-i-move-my-existing-mutual-fund-investments-to-coin), accessed 11 September 2026, illustrate how one receiving platform uses different routes for demat and SOA holdings. Its rules are specific to that platform and can change, but the broader lesson is stable: identify the holding mode before choosing the process.
...
The units already purchased do not normally vanish when an SIP is stopped. The guide to [withdrawing an SIP investment and stopping future instalments](/learn/can-you-withdraw-sip-anytime/) explains why these are separate actions.
...
Changing platforms also does not convert a regular plan into a direct plan. Read the separate comparison of [direct and regular mutual fund plans](/learn/direct-vs-regular-mutual-funds/) before changing the plan itself.
...
The mutual fund itself remains a market-linked investment throughout the process. Moving its record or access channel does not improve the scheme, remove risk or guarantee returns. If the underlying product is unclear, begin with [how mutual funds, units and NAV work in India](/learn/what-is-a-mutual-fund/) before changing the platform.
